...
if(username==null){
		...
		return;	
			...
			String name1=(String)request.getSession().getAttribute("name");
			 //(new AdminService()).log(user_name,name1,"区域统计查询",(new getRemortIP()).getRemoteAddress(request),(String)request.getSession().getAttribute("sys"));
...
<style type="text/css">
 end, fieldset, input, button, select, textarea {margin:0; padding:0;font-style: normal;font:12px/22px Arial, Helvetica, sans-serif;} 
...
Ext.onReady(function(){
    ...
    var  store = new Ext.data.Store({  
         proxy : new Ext.data.HttpProxy( {  
          url : 'servlet/AreaServlet',// 设置代理请求的url  
          method:'GET'
 ...
 newNameTD.innerHTML =store.getAt(i).get("area") ;  
 }
