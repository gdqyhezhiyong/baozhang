...
Ext.onReady(function(){
    ...
    var  store = new Ext.data.Store({  
         proxy : new Ext.data.HttpProxy( {  
          url : 'servlet/WorkHoursServlet',// 设置代理请求的url  
          method:'GET'
...
newTR.style.cssText="line-height:25px;border-color:#808080";
 ...
 var newNameTD = newTR.insertCell(i);  
  newNameTD.style.cssText="text-align:center;border-color:#000033;font-size:12px;border:1px;heigth:48px;border-color:#808080;background-color: #B0D1DB;font-weight:bold"; 
 newNameTD.innerHTML =store.getAt(i).get("work") ;  
 }
 var newNameTD = newTR.insertCell(store.getCount());  
 newNameTD.style.cssText="text-align:center;border-color:#000033;font-size:12px;border:1px;heigth:48px;border-color:#808080;background-color: #B0D1DB;font-weight:bold"; 
 newNameTD.innerHTML ="总工时";
 ...
 var newNameTD = newTR.insertCell(i);  
 newNameTD.style.cssText="text-align:center;border-color:#000033;font-size:12px;border:1px;heigth:25px;border-color:#B0D1DB;font-weight:bold;background-color:#D4DFFF"; 
