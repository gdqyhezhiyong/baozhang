...
<link href="style/login123.css" rel="stylesheet" type="text/css"/>
<style type="text/css">
<!--
    ...
    <div class="login_middle">
            	...
            	<ul>
                	...
                	<li class="m">
                    	<ul>
                        	...
                        	<li class="txt">密　码：<input type="password" name="password" size="16" id="password"  >  <input type="hidden" name="goto" value=<%=goUrl%> ></li>
                            <li class="btn">
        ...
        <ul class="schoolinfo">
        	...
        	<li class="explain">
                ...
                <font color="#FF0000">*</font>初始密码身份证的后6位（包含X的为大写）<br />
