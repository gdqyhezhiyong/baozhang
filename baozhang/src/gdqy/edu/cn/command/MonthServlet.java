...
public class MonthServlet extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    List list = null;
    if ((star_time == null) && (end_time == null) && (((area == null) || ("".equals(area.trim())))))
    {
      list = new AdminService().getMonthCount((String)request.getSession().getAttribute("sys"));
    }
    else list = new AdminService().getMonthCount(star_time, end_time, (String)request.getSession().getAttribute("sys"), area);
