...
public class AreaServlet extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    List list = null;
    if ((star_time == null) && (end_time == null) && (((area == null) || ("".equals(area)))))
    {
      list = new AdminService().getAreaCount((String)request.getSession().getAttribute("sys"));
    }
    else list = new AdminService().getAreaCount(star_time, end_time, (String)request.getSession().getAttribute("sys"), area);
