...
public class CountSuppliesServlet extends HttpServlet
{
  public void destroy()
  {
    super.destroy();
    ...
    throws ServletException, IOException
  {
    ...
    {
      list = new AdminService().getCountSupplies(star_time, end_time, (String)request.getSession().getAttribute("sys"), area);
