...
public class LogSelectServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Logs> list=null;
           if(user_name==null&&start_time==null&&end_time==null){
        	
        		list = (new AdminService()).getLogs(sort,dir,(String)request.getSession().getAttribute("sys"));
        	 
           }
           else list = (new AdminService()).getLogs(user_name,start_time,end_time,sort,dir,(String)request.getSession().getAttribute("sys"));
