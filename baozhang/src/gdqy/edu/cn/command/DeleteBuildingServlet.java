...
public class DeleteBuildingServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String name1=(String)request.getSession().getAttribute("name");
		 (new AdminService()).log(user_name,name1,"楼栋删除",(new getRemortIP()).getRemoteAddress(request),(String)request.getSession().getAttribute("sys"));
       ...
       int rs = (new AdminService()).delteBuilding(id[i]);
       count++;
        }
			out.write(""+count);
		out.close();
